...
* [[`c69b2b5932`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/c69b2b5932)] - chore(rewrite): apply OpenRewrite Java 17 and static analysis cleanups (Tim Bernhard)
* [[`9592626a56`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/9592626a56)] - feat(arch): modernize build to Java 17, fix Hibernate antipatterns and add test suites (Tim Bernhard)
* [[`c8e695ce81`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/c8e695ce81)] - Merge pull request #45 from BernhardWebstudio/dependabot/maven/com.fasterxml.jackson.core-jackson-databind-2.22.1 (Tim Bernhard)
* [[`aa428359cf`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/aa428359cf)] - Bump com.fasterxml.jackson.core:jackson-databind from 2.22.0 to 2.22.1 (dependabot[bot])
* [[`f2a64e4755`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/f2a64e4755)] - Merge pull request #44 from BernhardWebstudio/dependabot/maven/com.fasterxml.jackson.core-jackson-databind-2.22.0 (Tim Bernhard)
* [[`bd69288a6f`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/bd69288a6f)] - Bump com.fasterxml.jackson.core:jackson-databind from 2.19.2 to 2.22.0 (dependabot[bot])
* [[`00b3cf9323`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/00b3cf9323)] - Improve script detection (Tim Bernhard)
* [[`14db14b33b`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/14db14b33b)] - Rename some dist files (Tim Bernhard)
* [[`b9b500b1a7`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/b9b500b1a7)] - Stop uploading zip, stick with jar and exe instead (Tim Bernhard)
* [[`5c85ec3f54`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/5c85ec3f54)] - Next iteration on export (Tim Bernhard)
* [[`b41994bcb4`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/b41994bcb4)] - Correct/update pools for fylr (Tim Bernhard)
* [[`8cb791562c`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/8cb791562c)] - Build fixes and chromium QR detector improvements (Tim Bernhard)
* [[`3faadb0da4`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/3faadb0da4)] - Add native Swift QR Scanner (Tim Bernhard)
* [[`c66920ed19`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/c66920ed19)] - Increase fylr timeouts (Tim Bernhard)
* [[`0b8ef6421a`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/0b8ef6421a)] - Potential fix for fylr export (Tim Bernhard)
* [[`93cefb55eb`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/93cefb55eb)] - Switch from put to post for fylr (Tim Bernhard)
* [[`1df7c39087`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/1df7c39087)] - Use v1 API in all cases (Tim Bernhard)
* [[`560654ba5e`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/560654ba5e)] - Implement fylr compatibility (Tim Bernhard)
* [[`18e0d56546`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/18e0d56546)] - Some more logging (Tim Bernhard)
* [[`f1e5818bb8`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/f1e5818bb8)] - Improve various logging (Tim Bernhard)
* [[`2087b064eb`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/2087b064eb)] - Some more logging (Tim Bernhard)
* [[`968e5eccee`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/968e5eccee)] - Possibly report more errors that need reporting (Tim Bernhard)
* [[`05f02ca4ed`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/05f02ca4ed)] - Improve logging of file scan (Tim Bernhard)
* [[`392a4058b1`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/392a4058b1)] - Fix issue where counting may have been incorrect in image scan of directory (Tim Bernhard)
* [[`2e93728547`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/2e93728547)] - Potentially fix issue where scan job would exit too early (Tim Bernhard)
* [[`93f056cbe0`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/93f056cbe0)] - Add Open Street Map as a location method (Tim Bernhard)
* [[`0c07cd0738`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/0c07cd0738)] - Align button right also on Windows (Tim Bernhard)
* [[`5b8669f770`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/5b8669f770)] - Fix issue where Georeference map would not show (Tim Bernhard)
* [[`d73e8471c1`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/d73e8471c1)] - Exclude orphaned collectors (Tim Bernhard)
* [[`8a0b0128e8`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/8a0b0128e8)] - Use a more complex search for the country, to include alternative names (Tim Bernhard)
* [[`b32530c5b8`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/b32530c5b8)] - Always make primarydivision Kanton/Provinz/Bundesland (Tim Bernhard)
* [[`043df39793`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/043df39793)] - Merge branch 'master' of github.com:BernhardWebstudio/DataShot\_DesktopApp (Tim Bernhard)
* [[`92d437e00f`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/92d437e00f)] - Attempt to be better with location finding (Tim Bernhard)
* [[`863d61a138`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/863d61a138)] - Fix typo (Tim Bernhard)
* [[`c6a433a3f5`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/c6a433a3f5)] - Improve resolution of region type (Tim Bernhard)
* [[`380f91051b`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/380f91051b)] - Merge branch 'master' of github.com:BernhardWebstudio/DataShot\_DesktopApp (Tim Bernhard)
* [[`27a8fdc39a`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/27a8fdc39a)] - Some more defaults (Tim Bernhard)
* [[`dbf93d5d56`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/dbf93d5d56)] - Further improve performance and status message of nahima export (Tim Bernhard)
* [[`f92bc5cb26`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/f92bc5cb26)] - Better status management in parallel nahima export (Tim Bernhard)
* [[`07754e0a37`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/07754e0a37)] - Try to parallelize Nahima Export (Tim Bernhard)
* [[`f31a547136`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/f31a547136)] - Fix an issue where authorship might be null (Tim Bernhard)
* [[`ae3156dc86`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/ae3156dc86)] - Fix compilation issues due dependencies (Tim Bernhard)
* [[`8986a59651`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/8986a59651)] - Further improvements to nahima export as requested (Tim Bernhard)
* [[`a1915c693b`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/a1915c693b)] - Fix issue where GBIF taxon id was not loaded (Tim Bernhard)
* [[`0f2052152a`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/0f2052152a)] - Implement edit for gbif in view pane (Tim Bernhard)
* [[`b8e7f40df1`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/b8e7f40df1)] - Possibly fix compilation (Tim Bernhard)
* [[`0c6df487d1`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/0c6df487d1)] - Create new db column, gbif taxon id (Tim Bernhard)
* [[`ba3a0357dd`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/ba3a0357dd)] - Fix another issue with tags (Tim Bernhard)
* [[`d082376316`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/d082376316)] - Improve changelog of most recent releases (Tim Bernhard)
* [[`31ccc0504b`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/31ccc0504b)] - Update changelog to publish Version v1.18.0 (Tim Bernhard)
...
- [[`48b6acc35e`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/48b6acc35e)] - Fix issue where batch update might fail for collectors (Tim Bernhard)
...
- [[`4d709cebec`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/4d709cebec)] - Do trim the melia statistics families before querying to reduce error proneness (Tim Bernhard)
...
- [[`93e66caf44`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/93e66caf44)] - Merge branch 'master' of github.com:BernhardWebstudio/DataShot_DesktopApp (Tim Bernhard)
...
- [[`edacdc0874`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/edacdc0874)] - Exclude more comparisons in LatLong emptycheck – fix #20, ETHEntColl/DataShot_DesktopApp_ETH#9 (Tim Bernhard)
- [[`8597231923`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/8597231923)] - Repair search by 'Entry by' (fix #19, ETHEntColl/DataShot_DesktopApp_ETH#12) (Tim Bernhard)
...
- [[`fea6575ce0`](https://github.com/BernhardWebstudio/DataShot_DesktopApp/commit/fea6575ce0)] - Fix issue where missing transaction commit led to dets being deleted (#15) (Tim Bernhard)
