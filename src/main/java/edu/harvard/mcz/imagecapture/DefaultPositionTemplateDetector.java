 ...
 * in an image file. This class makes the assumption that a template can be
 * uniqely idenfified by the location of the barcode in the image. Each template
 * must have the bardcode in a uniquely different place.
 *
...
public class DefaultPositionTemplateDetector implements PositionTemplateDetector {
	...
	private static final Logger log = LoggerFactory.getLogger(DefaultPositionTemplateDetector.class);
