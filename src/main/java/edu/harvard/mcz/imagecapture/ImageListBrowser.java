...
/**
 * ImageListBrowser is a Searchable, Sortable, tabular view of multiple specimen
 * images with Edit buttons to display the details for a specimen found in an
 * image.
 */
public class ImageListBrowser extends JPanel {
	...
	private void newFilter() {
		...
		try {
			if (jTextFieldFilename.getText().equals("") && jTextFieldBarcode.getText().equals("")
					&& jTextFieldDrawerNumber.getText().equals("")) {
