...
public class KeyboardShortcutManager extends AbstractTableModel {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(KeyboardShortcutManager.class);
   ...
   *
   * @param name          a unique ID for the action, used as key in the
   *     properties file
  ...
  public KeyStroke getShortcut(String name) { return getShortcut(name, null); }
  ...
  public void saveProperties() {
    ...
    try {
      ...
      String comment = ImageCaptureApp.APP_NAME + " " +
                       ImageCaptureApp.getAppVersion() + " Properties";
      comment +=
