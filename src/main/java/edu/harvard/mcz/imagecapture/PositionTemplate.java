 ...
 * Provides hard coded default template. Provides methods to get/set coordinates
 * as Dimension objects as a convenience over Template's get/set of individual
 * heights and widths as integers.
 * <p>
 * DefaultPositionTemplateDetector makes the assumption that a template can be
 * uniquely identified by the location of the barcode in the image.
 * <p>
...
public class PositionTemplate {
	...
	/**
	 * Special case template for images that aren't split into component parts with
	 * a template.
	 *
	...
	private static final Logger log = LoggerFactory.getLogger(PositionTemplate.class);
	 ...
	 * coordinates on the image contain which information. The template cannot be
	 * changed for an instance of PositionTemplate once it has been instantiated.
	 * This constructor is the only means of setting the template to use. Create a
	 * new instance of PositionTemplate if you wish to use a different template.
	 * <p>
	 * The list of available templateIds can be retrieved with
	 * PositionTemplate.getTemplates().
	 *
	 * @param templateToUse
	 *            the templateID of the template to use in this instance of
	 *            PositionTemplate.
	 * @throws NoSuchTemplateException
	 *             when templateToUse doesn't exist.
	...
	public static List<String> getTemplateIds() {
		...
		String defaultTemplatesPropertiesVal = Singleton.getSingletonInstance().getProperties().getProperties()
	 ...
	 *
	 * @param image
	 *            the ICImage for which the PositionTemplate is to be returned.
	...
	public static PositionTemplate findTemplateForImage(ICImage image) throws ImageLoadException {
		...
		try {
			...
			try {
				...
				log.error("TEMPLATE_NO_COMPONENT_PARTS produced a NoSuchTemplateException.", e1);
				log.trace("Trace", e1);
	...
	/**
	 * Get the identifying name of this position template. This name is fixed for an
	 * instance during its construction. This name corresponds to one of the strings
	 * returned by PositionTemplate.getTemplates(); Redundant with getTemplateId()
	 *
	...
	/**
	 * @param utLabelPosition
	 *            the utLabelPosition to set
	 */
	 ...
	 * PositionTemplate. Contains hardcoded templates other than the default
	 * <p>
	 ...
	 * Get the identifying name of this position template. This name is fixed for an
	 * instance during its construction. This name corresponds to one of the strings
	 * returned by PositionTemplate.getTemplates(); Redundant with
