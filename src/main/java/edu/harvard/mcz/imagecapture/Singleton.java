...
public class Singleton {
   ...
   */
  public static Singleton getSingletonInstance() { return singletonInstance; }
   ...
   */
  public void setMainFrame(MainFrame aMainFrame) { mainFrame = aMainFrame; }
   ...
   * authenticated user.
   */
  public String getCurrentUsername() { return this.user.getUsername(); }
   ...
   */
  public String getUserFullName() { return this.user.getFullname(); }
  ...
  public void unsetCurrentUser() { user = null; }

  /**
   * @return the barcodeMatchedr
   */
  public BarcodeMatcher getBarcodeMatcher() { return barcodeMatcher; }
   ...
   */
  public BarcodeBuilder getBarcodeBuilder() { return barcodeBuilder; }
  ...
  public RunnableJobTableModel getJobList() { return jobList; }
