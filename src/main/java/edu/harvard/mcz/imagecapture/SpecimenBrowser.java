...
public class SpecimenBrowser extends JPanel implements DataChangeListener {
  ...
  public SpecimenBrowser(Specimen specimenSearchCriteria, boolean like) {
	...
	public SpecimenBrowser(Specimen specimenSearchCriteria, boolean like, int maxResults, int offset) {
		super();
  ...
  private JTable getJTable() {
    if (jTable == null) {
      ...
      if (searchCriteria == null) {
        ...
        if (useLike) {
          model =
              new SpecimenListTableModel(s.findByExampleLike(searchCriteria, maxResults, offset));
        } else {
          model = new SpecimenListTableModel(s.findByExample(searchCriteria, maxResults, offset));
        }
      }
  ...
  private JTextField getJTextField() {
    if (jTextField == null) {
      ...
      jTextField.addKeyListener(new java.awt.event.KeyAdapter() {
        public void keyTyped(java.awt.event.KeyEvent e) { newFilter(); }
      });
    }
    return jTextField;
  }
  ...
  private void newFilter() {
    ...
    try {
      ...
      rf = RowFilter.andFilter(
          (Iterable<RowFilter<SpecimenListTableModel, Object>>)i);
