...
public class SpecimenController {
	...
	private static final Logger log = LoggerFactory.getLogger(SpecimenController.class);
	...
	/**
	 * Create a specimen controller for a specimen in a table. If this constructor
	 * suceeds then isInTable() will return true.
	 *
	 * @param aSpecimen
	 *            the specimen
	 * @param aModel
	 *            a SpecimenListTableModel containing the specimen
	 * @param aTable
	 *            the table in which the SpecimenListTableModel is shown.
	 * @param theCurrentRow
	 *            the row of the specimen in the view of the table.
	 * @throws NoSuchRecordException
	 */
	public SpecimenController(Specimen aSpecimen, SpecimenListTableModel aModel, JTable aTable, int theCurrentRow,
			int theCurrentColumn) throws NoSuchRecordException {
		if (aSpecimen == null) {
			throw new NoSuchRecordException("Can't create a specimen controller with a null specimen");
		}
	...
	/**
	 * If the specimen for this controller is in a table model, switches out for
	 * next specimen in model. If the specimen isn't in a table model, does nothing.
	 * If at last position in table model, does nothing.
	 *
	 * @return true if specimen was changed, false if not, false if isInTable() is
	 *         false.
	 */
	...
	/**
	 * Save the specimen. Note that this method does not check permissions
	 *
	 * @return
	...
	/**
	 * Determine if the specimen controled by this controller is part of a list of
	 * specimens in a table model or not.
	 *
