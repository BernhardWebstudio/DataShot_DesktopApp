...
//		}
    ...
    private void init() {
        ...
        }
        {
            ...
            comboBoxType.setModel(new DefaultComboBoxModel(new String[]{"caste", "scientific name", "sex", "life stage", "part association"}));
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (item != null) {
                        ...
                        if (item.equals("part association")) {
                            comboBoxValue.setModel(new DefaultComboBoxModel(PartAssociation.getPartAssociationValues()));
                        }
                    }
                }
