...
public class UserListBrowser extends JPanel {
    ...
    private static final Logger log =
            LoggerFactory.getLogger(UserListBrowser.class);
    ...
    private JTable getJTable() {
        if (jTable == null) {
            ...
            jTable.setDefaultEditor(
                    Users.class, new ButtonEditor(ButtonEditor.OPEN_USER, thisPanel));
        }
        return jTable;
    }
    ...
    private JButton getJButtonAddUser() {
        if (jButtonAddUser == null) {
            ...
            try {
                jButtonAddUser.setIcon(new ImageIcon(this.getClass().getResource(
