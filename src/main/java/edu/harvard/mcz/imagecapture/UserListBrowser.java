...
public class UserListBrowser extends JPanel {
	...
	private static final Logger log = LoggerFactory.getLogger(UserListBrowser.class);
	...
	private JButton getJButtonAddUser() {
		if (jButtonAddUser == null) {
			...
			try {
				jButtonAddUser.setIcon(new ImageIcon(this.getClass()
						.getResource("/edu/harvard/mcz/imagecapture/resources/images/add_person_30px.png")));
			} catch (Exception e) {
