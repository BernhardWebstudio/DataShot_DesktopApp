...
public class WhatsThisImageDialog extends JDialog {
  ...
  private static final Log log =
      LogFactory.getLog(WhatsThisImageDialog.class); //  @jve:decl-index=0:
  ...
  public String getBarcode() { return this.jTextFieldBarcode.getText(); }

  public String getDrawerNumber() {
    return this.jTextFieldDrawerNumber.getText();
  }

  public void setImage(BufferedImage anImage) { imagePanel.setImage(anImage); }
  ...
  private JTextField getJTextFieldBarcode() {
    if (jTextFieldBarcode == null) {
      ...
      jTextFieldBarcode.addKeyListener(new java.awt.event.KeyAdapter() {
        public void keyTyped(java.awt.event.KeyEvent e) { checkValues(); }
      });
    }
