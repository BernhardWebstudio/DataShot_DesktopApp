...
public class BulkMedia {
	private static final Logger log = LoggerFactory.getLogger(BulkMedia.class);
	...
	protected void init() {
		...
		fileBase = Singleton.getSingletonInstance().getProperties().getProperties()
				.getProperty(ImageCaptureProperties.KEY_IMAGEBASE);
		urlBase = Singleton.getSingletonInstance().getProperties().getProperties()
