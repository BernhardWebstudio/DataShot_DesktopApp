...
public class LabelEncoder {
	...
	private static void addPageWithColCells(PdfPTable table, ArrayList<PdfPCell> cells,
	...
	private BitMatrix getQRCodeMatrix() {
		...
		try {
			...
			Hashtable<EncodeHintType, ErrorCorrectionLevel> hints = new Hashtable<EncodeHintType, ErrorCorrectionLevel>(); // set
