...
public class UnitTrayLabelBrowser extends JFrame {
  ...
  private JButton getJButton() {
    if (jButton == null) {
      ...
      jButton.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent e) { addRow(); }
      });
    }
    return jButton;
  }
  ...
  private void addRow() {
    ...
    // scroll to last row in table.  Make first cell modal in latest row
    // editable.
    jTable.scrollRectToVisible(
        jTable.getCellRect(jTable.getRowCount(), 1, false));
  ...
  private JButton getJButton1() {
    if (jButton1 == null) {
      ...
      jButton1.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent e) { makePDF(); }
      });
    }
    return jButton1;
  }
  ...
  public void makePDF() {
    ...
    JOptionPane.showMessageDialog(thisFrame, message, "PDF Generation",
    ...
    if (jMenuItemAddRow == null) {
      ...
      jMenuItemAddRow.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent e) {
          ...
          // jTable.scrollRectToVisible(jTable.getCellRect(jTable.getRowCount(),
          // 1, false)); jTable.editCellAt(jTable.getRowCount(), 1);
          ...
          Rectangle newCell =
              new Rectangle(1, jTable.getRowHeight() * (jTable.getRowCount()),
                            10, jTable.getRowHeight());
