 ...
 */
public class Determination implements java.io.Serializable, Cloneable {
	...
	public Determination(Specimen specimen, String genus, String specificEpithet, String subspecificEpithet,
			String infraspecificEpithet, String infraspecificRank, String authorship, String unNamedForm,
			String identifiedBy, String typeStatus, String speciesNumber, String natureOfId) {
		this.specimen = specimen;
		this.genus = genus;
	...
	public Determination clone() {
		Determination newDet = new Determination(specimen, genus, specificEpithet, subspecificEpithet,
				infraspecificEpithet, infraspecificRank, authorship, unNamedForm, identifiedBy, typeStatus,
				speciesNumber, natureOfId);
		newDet.setVerbatimText(this.verbatimText);
		newDet.setRemarks(this.remarks);
		newDet.setDateIdentified(this.dateIdentified);
		return newDet;
	}
