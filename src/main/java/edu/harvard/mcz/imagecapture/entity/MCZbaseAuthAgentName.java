 ...
 * authority file) Use database link agent_name@mczbase_auth and public synonym
 ...
 * agent_name@MCZBASE_AUTH; select * from MCZBASE_AUTH_AGENT_NAME; Use database
 * link and view in production Oracle, table below in test MySQL.
 * <p>
 * CREATE TABLE MCZBASE_AUTH_AGENT_NAME ( AGENT_NAME_ID bigint NOT NULL primary
 * key auto_increment, AGENT_ID bigint, AGENT_NAME_TYPE VARCHAR(18),
 * DONOR_CARD_PRESENT_FG int, AGENT_NAME VARCHAR(184) );
 */
public class MCZbaseAuthAgentName {
	...
	/**
	 * @param agent_name_type
	 *            the agent_name_type to set
	 */
	...
	/**
	 * @param donor_card_present_fg
	 *            the donor_card_present_fg to set
	 */
