...
public class MCZbaseGeogAuthRec {
  private static final Logger log =
      LoggerFactory.getLogger(MCZbaseGeogAuthRec.class);
   ...
   */
  public Long getGeog_auth_rec_id() { return geog_auth_rec_id; }
   ...
   */
  public String getContinent_ocean() { return continent_ocean; }
   ...
   */
  public String getState_prov() { return state_prov; }

  /**
   * @param state_prov the state_prov to set
   */
  public void setState_prov(String state_prov) { this.state_prov = state_prov; }
   ...
   */
  public void setQuad(String quad) { this.quad = quad; }
   ...
   */
  public String getIsland_group() { return island_group; }
   ...
   */
  public void setSea(String sea) { this.sea = sea; }

  /**
   * @return the valid_catalog_term_fg
   */
  public int getValid_catalog_term_fg() { return valid_catalog_term_fg; }
   ...
   */
  public String getSource_authority() { return source_authority; }
   ...
   */
  public String getHigher_geog() { return higher_geog; }
   ...
   */
  public String getOcean_subregion() { return ocean_subregion; }
