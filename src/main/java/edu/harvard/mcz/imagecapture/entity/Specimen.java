...
public class Specimen implements Serializable {
	...
	private String creatingPath; // A path for image file, denormalized from Image.path for
	...
	public Specimen(String barcode, String drawerNumber, String typeStatus, Long typeNumber, String citedInPublication,
			String features, String family, String subfamily, String tribe, String genus, String specificEpithet,
			String subspecificEpithet, String infraspecificEpithet, String infraspecificRank, String authorship,
			String unNamedForm, String identificationQualifier, String identifiedBy, String country,
			String primaryDivison, String specificLocality, String verbatimLocality, Long minimum_elevation,
			Long maximum_elevation, String elev_units, String collectingMethod, String dateNos, String dateEmerged,
			String dateEmergedIndicator, String dateCollected, String dateCollectedIndicator, String collection,
			String specimenNotes, String lifeStage, String preparationType, String sex, String microhabitat,
			String habitat, String associatedTaxon, String questions, String inferences, String locationInCollection,
			String workFlowStatus, String createdBy, Date dateCreated, Date dateLastUpdated, String lastUpdatedBy,
			Boolean validDistributionFlag, Set<Collector> collectors, Set<Determination> determinations,
			Set<Tracking> trackings, Set<Number> numbers, Set<ICImage> ICImages, Set<SpecimenPart> specimenParts) {
		this.barcode = barcode;
	...
	public void setOrder(String order) {
		...
		if (this.higherOrder != null && this.higherOrder.length() > supportedFieldLen && supportedFieldLen > 0) {
	...
	public Boolean isEditable(Users user) {
		...
		if (user != null) {
			canEdit = (user.isUserRole(Users.ROLE_FULL) || user.isUserRole(Users.ROLE_ADMINISTRATOR))
					|| (canEdit && !Objects.equals(this.getTypeStatus(), WorkFlowStatus.STAGE_CLEAN));
		} else {
	...
	public final void setDefaults() {
		...
		/*
		 * if (this.verbatimCollection==null) { this.verbatimCollection = ""; } if
		 * (this.verbatimCollector==null) { this.verbatimCollector = ""; } if
		 * (this.verbatimLocality==null) { this.verbatimLocality = ""; } if
		 * (this.verbatimNumbers==null) { this.verbatimNumbers = ""; } if
		 * (this.verbatimUnclassifiedText==null) { this.verbatimUnclassifiedText = ""; }
		 */
		// this.dateCreated = new Date();
	}

	/**
	 * Clear the default values for a new specimen object, as in one that is to be
	 * used as the search criteria for a search by pattern.
	 */
	...
	public void setDrawerNumber(String drawerNumber) {
		...
		if (this.drawerNumber != null
				&& this.drawerNumber.length() > MetadataRetriever.getFieldLength(Specimen.class, "DrawerNumber")) {
			this.drawerNumber = this.drawerNumber.substring(0,
	...
	/**
	 * @param identificationRemarks
	 *            the identificationRemarks to set
	 */
	 ...
	 *            the verbatimUnclassifiedText to set
	 */
	...
	/**
	 * @param verbatimClusterIdentifier
	 *            the verbatimClusterIdentifier to set
	 */
	...
	/**
	 * @param externalWorkflowProcess
	 *            the externalWorkflowProcess to set
	 */
	...
	/**
	 * @param externalWorkflowDate
	 *            the externalWorkflowDate to set
	 */
	...
	/**
	 * @param minimum_elevation
	 *            the minimum_elevation to set
	 */
	...
	/**
	 * @param maximum_elevation
	 *            the maximum_elevation to set
	 */
	...
	/**
	 * @param flagInBulkloader
	 *            the flagInBulkloader to set
	 */
	...
	/**
	 * @param flagAncilaryAlsoInMCZbase
	 *            the flagAncilaryAlsoInMCZbase to set
	 */
	...
	/**
	 * @param creatingFilename
	 *            the creatingFilename to set
	 */
	...
	public Set<Determination> getAllDeterminations() {
		...
		thisDet.setVerbatimText("Main determination created by " + ImageCaptureApp.APP_NAME + " "
	...
	/**
	 * @param externalHistory
	 *            the externalHistory to set
	 */
	...
	/**
	 * Set the value of specificLocality to a string that has a meaning of there
	 * being no specific locality data. MCZbase requires a non-null value for
	 * specific locality on bulkloader ingest.
	 */
