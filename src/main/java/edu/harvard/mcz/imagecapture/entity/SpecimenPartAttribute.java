...
public class SpecimenPartAttribute implements Cloneable {
	 ...
	 * @param attributeDate
	 */
	public SpecimenPartAttribute(Long specimenPartAttributeId, SpecimenPart specimenPartId, String attributeType,
			String attributeValue, String attributeUnits, String attributeRemark, String attributeDeterminer,
			Date attributeDate) {
		this(specimenPartId, attributeType, attributeValue, attributeUnits, attributeRemark, attributeDeterminer,
				attributeDate);
	 ...
	 * @param attributeDate
	 */
	public SpecimenPartAttribute(SpecimenPart specimenPartId, String attributeType, String attributeValue,
			String attributeUnits, String attributeRemark, String attributeDeterminer, Date attributeDate) {
		super();
	...
	/**
	 * @param specimenPartAttributeId
	 *            the specimenPartAttributeId to set
	 */
	...
	/**
	 * @param attributeDeterminer
	 *            the attributeDeterminer to set
	 */
	...
	/**
	 * @param prepTypeAttributeDate
	 *            the prepTypeAttributeDate to set
	 */
	...
	@Override
	public Object clone() {
		SpecimenPartAttribute newAttr = new SpecimenPartAttribute(null, attributeType, attributeValue, attributeUnits,
				attributeRemark, attributeDeterminer, attributeDate == null ? null : (Date) attributeDate.clone());
		return newAttr;
	}
}
