...
public class UnitTrayLabel
   ...
   */
  public String getDrawerNumber() { return drawerNumber; }
  ...
  public void setPrinted(int printed) { this.printed = printed; }

  public int getNumberToPrint() { return this.numberToPrint; }
