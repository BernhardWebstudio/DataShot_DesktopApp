...
public class UnitTrayLabel implements TaxonNameReturner, DrawerNameReturner, CollectionReturner {
	...
	private static final Logger log = LoggerFactory.getLogger(UnitTrayLabel.class);
	 ...
	 * @param collection
	 */
	public UnitTrayLabel(Long id, String drawerNumber, String family, String subfamily, String tribe, String genus,
			String specificEpithet, String subspecificEpithet, String infraspecificEpithet, String infraspecificRank,
			String authorship, String unnamedForm, int printed, Date dateCreated, Date dateLastUpdated,
	 ...
	 * @param collection
	 */
	public UnitTrayLabel(String drawerNumber, String family, String subfamily, String tribe, String genus,
			String specificEpithet, String infraspecificEpithet, String infraspecificRank, String authorship,
			String collection) {
		super();
		this.drawerNumber = drawerNumber;
		this.family = family;
	 ...
	 */
	public UnitTrayLabel(String drawerNumber, String family, String subfamily, String tribe, String genus,
			String specificEpithet, String authorship, String collection) {
		super();
		this.drawerNumber = drawerNumber;
		this.family = family;
		this.subfamily = subfamily;
	 ...
	 */
	public UnitTrayLabel(String drawerNumber, String family, String subfamily, String tribe, String genus,
			String specificEpithet, String subspecificEpithet, String authorship, String collection) {
		super();
		this.drawerNumber = drawerNumber;
		this.family = family;
		this.subfamily = subfamily;
	...
	/**
	 * Factory method, given a JSON encoded string, as encoded with toJSONString(),
	 * extract the values from that string into a new instance of UnitTrayLabel so
	 * that they can be obtained by the appropriate returner interface
	 * (taxonnameReturner, drawernumberReturner, collectionReturner).
	 *
	 * @param jsonEncodedLabel
	 *            the JSON to decode.
	...
	public boolean equals(Object o) {
		...
		return java.util.Objects.equals(family, that.family) && java.util.Objects.equals(genus, that.genus)
