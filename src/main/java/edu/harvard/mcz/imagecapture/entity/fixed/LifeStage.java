...
public class LifeStage implements ValueLister {
	...
	public static String[] getLifeStageValues() {
		String[] lifestages = {"adult", "callow", "egg", "juvenile", "larva", "naiad", "non-adult", "nymph", "pharate",
				"pupa", "teneral adult", "teneral nymph", "1st instar", "2nd instar", "3rd instar", "4th instar",
