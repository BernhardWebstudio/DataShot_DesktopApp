...
public class VerbatimCount {
	private static final Logger log = LoggerFactory.getLogger(VerbatimCount.class);
	 ...
	 */
	public VerbatimCount(Integer count, String verbatimLocality, String verbatimDate, String verbatimCollector,
			String verbatimCollection, String verbatimNumbers, String verbatimUnclassfiedText) {
		this.count = count;
	...
	/**
	 * @param verbatimUnclassfiedText
	 *            the verbatimUnclassfiedText to set
	 */
