...
/**
 * BadTemplateException to be thrown when a template does not fit an image file
 * to which it is being applied. This exception should be thrown when there is a
 * problem applying a template, as opposed to NoSuchTemplateException which
 * should be thrown when trying to construct a PositionTemplate.
 *
