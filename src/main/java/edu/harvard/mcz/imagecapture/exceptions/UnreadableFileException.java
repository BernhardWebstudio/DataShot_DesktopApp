...
/**
 * UnreadableFileException can be thrown when a file can't be read for any
 * reason (non-existent, not allowed by security context, etc).
 */
public class UnreadableFileException extends Exception {
	...
	/**
	 * Exception to throw for any sort of problem reading a file.
	 */
