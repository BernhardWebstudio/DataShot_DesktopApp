...
public class JobCleanDirectory implements RunnableJob, Runnable {
   ...
   */
  public JobCleanDirectory() { init(SCAN_SELECT, null); }
  ...
  private List<File> getFileList() {
    ...
    if (Singleton.getSingletonInstance()
      ...
      JOptionPane.showMessageDialog(
          ...
          "Can't start scan.  Don't know where images are stored.  Set " +
          "imagbase property.",
      ...
      if (!ImageCaptureProperties.isInPathBelowBase(startPoint)) {
        ...
        String message = "Can only scan and cleanup files in a selected " +
                         ...
                         base +
                         (").\nYou must select some subdirectory within the " +
                          "base directory to cleanup.");
        JOptionPane.showMessageDialog(
            Singleton.getSingletonInstance().getMainFrame(), message,
