...
/**
 * RunnableJobErrorTableModel, table model for displaying error reports about
 * preprocessing images. Can handle different types of reports by specifying a
 * TYPE_ constant in the constructor.
 */
