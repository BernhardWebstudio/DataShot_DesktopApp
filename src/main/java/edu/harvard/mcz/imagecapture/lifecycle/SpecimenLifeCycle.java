...
public class SpecimenLifeCycle extends GenericLifeCycle<Specimen> {
    ...
    public List<Specimen> findByExampleLike(Specimen instance, int maxResults,
                                            int offset) {
        // as date last updated is a "similar" field, not an equal field, we have to extract it separate
        ...
        try {
            ...
            try {
                ...
                if (lastUpdated != null) {
                    ...
                    lastUpdatedDayStart.setHours(0); lastUpdatedDayStart.setMinutes(0); lastUpdatedDayStart.setSeconds(0);
                    Date lastUpdatedDayEnd = (Date) lastUpdated.clone();
                    lastUpdatedDayEnd.setHours(23); lastUpdatedDayEnd.setMinutes(59); lastUpdatedDayEnd.setSeconds(59);
