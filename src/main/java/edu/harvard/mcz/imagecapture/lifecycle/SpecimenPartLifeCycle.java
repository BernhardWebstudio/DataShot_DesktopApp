...
public class SpecimenPartLifeCycle {
	private static final Logger log = LoggerFactory.getLogger(SpecimenPartLifeCycle.class);
	 ...
	 *
	 * @param instance
	 *            of a SpecimenPart that that is to be saved.
	 * @throws SaveFailedException
	 */
	 ...
	 *
	 * @param instance
	 *            of a SpecimenPart that that is to be removed.
	 * @throws SaveFailedException
	 */
