...
/**
 * Exception on data loading indicating that the target record for update from
 * the data load has moved further down the the workflow within the DataShot
 * system and is past the point where the desired load is allowed.
 */
public class LoadTargetMovedOnException extends LoadException {
	 ...
	 */
	public LoadTargetMovedOnException(String message, Throwable cause, boolean enableSuppression,
