...
/**
 * Passes mouse wheel events to the parent component if this component cannot
 * scroll further in the given direction.
 * <p>
 * This behavior is a little better than Swing's default behavior but still
 * worse than the behavior of Google Chrome, which remembers the currently
 * scrolling component and sticks to it until a timeout happens.
 *
