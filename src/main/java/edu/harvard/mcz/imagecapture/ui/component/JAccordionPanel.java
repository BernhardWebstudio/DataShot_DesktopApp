...
public class JAccordionPanel extends JPanel {
	...
	private static final Logger log = LoggerFactory.getLogger(JAccordionPanel.class);
	...
	/**
	 * Instantiate the panel with a button to trigger the visibility of another
	 * component
	 *
	 * @param titleOpen
	 *            the button text to show when the content is visible
	 * @param titleClosed
	 *            the button text to show when the content is hidden
	 * @param content
	 *            the other component to trigger the visibility of
	 */
