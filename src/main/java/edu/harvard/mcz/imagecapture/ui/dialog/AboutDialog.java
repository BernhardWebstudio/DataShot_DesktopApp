...
/**
 * AboutDialog, a dialog describing the application, its version, contributors,
 * and libraries.
 * <p>
 * Note: Revision, as shown here is one revision behind the commit to CVS of the
 * jar file.
 */
public class AboutDialog extends JDialog {
	...
	private JPanel getJPanelContent() {
		if (jPanel == null) {
			...
			// set fields
			String[] labels = {"Application", "Version", "Description", "License", "Copyright", "Contributors",
					"Libraries"};

			Component[] fields = {this.getJTextFieldApp(), this.getJTextFieldVersion(), this.getJTextAreaDescription(),
					this.getTextAreaLicense(), this.getJTextFieldCopyright(), this.getJTextFieldContributors(),
