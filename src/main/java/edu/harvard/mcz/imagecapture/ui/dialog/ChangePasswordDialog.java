...
public class ChangePasswordDialog extends JDialog {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(ChangePasswordDialog.class);
  ...
  private void setValues() { jTextField.setText(user.getFullname()); }
        ...
        public void actionPerformed(java.awt.event.ActionEvent e) {
          ...
          if (user != null) {
            ...
            if (hash1.equals(hash2)) {
              if (Users.testProposedPassword(
                      String.valueOf(jPasswordField1.getPassword()),
                      user.getUsername())) {
                // check that old password is correct
                if (LoginDialog.hashPassword(jPasswordFieldOld)
                        .equals(user.getHash())) {
                  try {
                ...
                jLabelResponse.setText("New password isn't complex enough." +
                                       Users.PASSWORD_RULES_MESSAGE);
              }
            } else {
