...
public class PositionTemplateBoxDialog extends JDialog {
	...
	/**
	 * Don't call this constructor, use PositionTemplateBoxDialog(Frame owner,
	 * Dimension ImageSize, Dimension aULToChange, Dimension aSizeToChange, String
	 * description) and provide values to edit instead. Protected so that it can be
	 * overridden in a class that extends this dialog (presumbably to create a new
	...
	/**
	 * Dialog to obtain new values for the upper left corner and size of a
	 * rectangular box drawn on an image identified by the upper left corner of the
	 * box and the height and width of the box in all in units of pixels.
	 *
	 * @param owner
	 *            the parent frame of this dialog.
	 * @param imageSize
	 *            the height and width of the image onto which this box is placed
	 * @param aULToChange
	 *            the upper left corner of the box, in units of pixels of the image
	 * @param aSizeToChange
	 *            the height and width of the box, in units of pixels of the image
	 * @param description
	 *            a text description of the box to display on the dialog.
	 * @throws BadTemplateException
	 *             if a dimension parameter has a height or width less than or equal
	 *             to zero (aULtoChange can be 0).
	 */
	public PositionTemplateBoxDialog(Frame owner, Dimension imageSize, Dimension aULToChange, Dimension aSizeToChange,
			String description) throws BadTemplateException {
	...
	/**
	 * Get the upper left coordinate of the box in pixels on the original image.
	 *
	...
	/**
	 * @param ul
	 *            the upper left coordinate of the box to set
	 * @throws BadTemplateException
	 *             if ul has a height or width less than zero (zero is ok).
	 */
	 ...
	 *            the size to set
	 * @throws BadTemplateException
	 *             if the size has a height or width less than or equal to 0.
	 */
	...
	private JButton getJButtonSave() {
		if (jButtonSave == null) {
			...
			jButtonSave.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					try {
						setUL(new Dimension(Integer.valueOf(jTextFieldULX.getText()),
								Integer.valueOf(jTextFieldULY.getText())));
						setSize(new Dimension(Integer.valueOf(jTextFieldSizeWidth.getText()),
								Integer.valueOf(jTextFieldSizeHeight.getText())));
						if (validateValues()) {
