...
public class RunnableJobReportDialog extends JDialog {
	...
	private static final Logger log = LoggerFactory.getLogger(RunnableJobReportDialog.class);
			...
			copyReportButton.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(ActionEvent actionEvent) {
					StringSelection selection = new StringSelection(
							textToCopy == null ? jTextArea.getText() : textToCopy);
	...
	protected void serializeTableModel() {
		...
		try {
			...
			JOptionPane.showMessageDialog(Singleton.getSingletonInstance().getMainFrame(),
					"Saved report to file: " + filename, "Report to CSV file", JOptionPane.INFORMATION_MESSAGE);
		} catch (IOException e) {
			log.error("Error", e);
		} finally {
			try {
