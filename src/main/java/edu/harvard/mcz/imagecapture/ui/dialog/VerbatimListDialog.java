...
public class VerbatimListDialog extends JDialog implements DataChangeListener {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(VerbatimListDialog.class);
   ...
   * Create the dialog.
   */
  public VerbatimListDialog() { init(); }
  ...
  protected void init() {
    ...
    table = new JTable(
        new VerbatimCountTableModel(sls.countDistinctVerbatimValues()));
    table.setDefaultRenderer(VerbatimCount.class, new ButtonRenderer("Edit"));
    table.setDefaultEditor(
        VerbatimCount.class,
        new ButtonEditor(ButtonEditor.OPEN_VERBATIM_CLASSIFY, this));
