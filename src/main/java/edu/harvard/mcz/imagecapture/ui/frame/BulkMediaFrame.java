...
public class BulkMediaFrame extends JFrame implements PropertyChangeListener {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(BulkMediaFrame.class);
  ...
  private void init() {
    ...
    JLabel lblBaseUri =
        new JLabel("Base URI (first part of path to images on the web)");
    ...
    textField_1.setText(Singleton.getSingletonInstance()
                            .getProperties()
                            .getProperties()
    ...
    JLabel lblThumbnailGenerationIs =
        new JLabel("Thumbnail generation is not reported on the progress bar.");
      ...
      if (returnValue == JFileChooser.APPROVE_OPTION) {
        ...
        JOptionPane.showMessageDialog(
            ...
            "Done.  Checked " + matchCount + "  files out of " + fileCount +
                ".\nResult is in " + BulkMediaFrame.BULKFILENAME,
