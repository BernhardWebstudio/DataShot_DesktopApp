...
/**
 * Display the history of database record creation and updates for specimens
 * including the history of status changes in the workflow. Can display either
 * the history for a single specimen or the entire tracking table for all
 * specimens.
 */
