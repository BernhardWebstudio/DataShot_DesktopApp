...
/**
 * ImagePanelForDrawing extends ImagePanel to allow drawing arbitrary boxes on
 * top of an image that is scaled to fit into an ImagePanel.
 */
public class ImagePanelForDrawing extends ImagePanel implements Serializable {
	...
	/**
	 * Draw an outline box with dimensions scaled to fit onto the current zoom of
	 * the image. Parameters are provided as pixel dimensions unscaled relative to
	 * the original image. If any of the parameters are null, nothing will be drawn.
	 *
	 * @param upperLeft
	 *            position (in pixels of the original image) of the upper left
	 *            corner of the box.
	 * @param size
	 *            height and width (in pixels of the original image) of the box to
	 *            draw.
	 * @param color
	 *            outline color of the box to draw.
	 */
	 ...
	 *            outline color of the box to draw.
	 * @param stroke
	 *            pen stroke to use to draw the box outline
	 */
