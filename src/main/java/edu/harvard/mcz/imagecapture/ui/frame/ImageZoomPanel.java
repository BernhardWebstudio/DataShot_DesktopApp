...
/**
 * ImageZoomPanel displays an image in an ImagePanel within a JScrollPane along
 * with a set of zoom controls.
 *
 * @see ImagePanel
...
public class ImageZoomPanel extends JPanel implements MouseListener {
	...
	private static final Logger log = LoggerFactory.getLogger(ImageZoomPanel.class);
	...
	private void initialize() {
		...
		URL cursorFile = this.getClass()
				.getResource("/edu/harvard/mcz/imagecapture/resources/images/magnifying_glass.gif");
		try {
