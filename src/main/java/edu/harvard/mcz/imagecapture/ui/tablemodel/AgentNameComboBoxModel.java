 ...
 *
 */
public class AgentNameComboBoxModel
    implements ComboBoxModel<MCZbaseAuthAgentName> {
  private static final long serialVersionUID = -4856432985354519476L;

  private static final Logger log =
      LoggerFactory.getLogger(AgentNameComboBoxModel.class);
      ...
      while (i.hasNext() && !done) {
        ...
        try {
          if (higher.getAgent_name() != null &&
              higher.getAgent_name().equals(
                  ((MCZbaseAuthAgentName)anItem).getAgent_name())) {
   ...
   * @return
   */
  public List<MCZbaseAuthAgentName> getModel() { return this.model; }
}
