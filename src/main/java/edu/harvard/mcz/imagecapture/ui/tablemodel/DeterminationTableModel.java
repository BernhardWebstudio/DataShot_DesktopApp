...
public class DeterminationTableModel extends AbstractTableModel {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(DeterminationTableModel.class);
   ...
   *
   * @param aDeterminationList the lists of determinations to display in the
   *     table.
   * @param enableIdEditor     true to include the determinationId to the table
   *     model in an editable
   *                           column.
   */
  public DeterminationTableModel(Set<Determination> aDeterminationList,
                                 boolean enableIdEditor) {
  ...
  public Object getValueAt(int rowIndex, int columnIndex) {
    ...
    switch (columnIndex) {
      //		case ROW_ID:
      //		    returnvalue =
      //((Determination)determinations.toArray()[rowIndex]).getDeterminationId();
      //		    break;
    case SPECIES_NUMBER:
      returnvalue = ((Determination)determinations.toArray()[rowIndex])
                        .getSpeciesNumber();
      break;
    case 1:
      returnvalue =
          ((Determination)determinations.toArray()[rowIndex]).getGenus();
      break;
    case 2:
      returnvalue = ((Determination)determinations.toArray()[rowIndex])
                        .getSpecificEpithet();
    ...
    case 6:
      returnvalue =
          ((Determination)determinations.toArray()[rowIndex]).getAuthorship();
      break;
    case ROW_TYPESTATUS:
      returnvalue =
          ((Determination)determinations.toArray()[rowIndex]).getTypeStatus();
      break;
    case ROW_IDENTIFIEDBY:
      returnvalue =
          ((Determination)determinations.toArray()[rowIndex]).getIdentifiedBy();
      break;
    case 9:
      returnvalue =
          ((Determination)determinations.toArray()[rowIndex]).getUnNamedForm();
      break;
    case 10:
      returnvalue =
          ((Determination)determinations.toArray()[rowIndex]).getVerbatimText();
      break;
    case ROW_NATUREOFID:
      returnvalue =
          ((Determination)determinations.toArray()[rowIndex]).getNatureOfId();
      break;
    ...
    case 13:
      returnvalue =
          ((Determination)determinations.toArray()[rowIndex]).getRemarks();
      break;
    case ROW_SPECIMEN:
      returnvalue = ((Determination)determinations.toArray()[rowIndex])
                        .getSpecimen()
  ...
  public void setValueAt(Object value, int rowIndex, int columnIndex) {
    switch (columnIndex) {
      ...
      //		    break;
    case SPECIES_NUMBER:
      ((Determination)determinations.toArray()[rowIndex])
          .setSpeciesNumber((String)value);
      break;
    case 1:
      ((Determination)determinations.toArray()[rowIndex])
    ...
    case 3:
      ((Determination)determinations.toArray()[rowIndex])
          .setSubspecificEpithet((String)value);
      break;
    case 4:
      ((Determination)determinations.toArray()[rowIndex])
    ...
    case 5:
      ((Determination)determinations.toArray()[rowIndex])
          .setInfraspecificRank((String)value);
      break;
    case 6:
      ((Determination)determinations.toArray()[rowIndex])
          .setAuthorship((String)value);
      break;
    case ROW_TYPESTATUS:
      ((Determination)determinations.toArray()[rowIndex])
    ...
    case 9:
      ((Determination)determinations.toArray()[rowIndex])
          .setUnNamedForm((String)value);
      break;
    case 10:
      ((Determination)determinations.toArray()[rowIndex])
          .setVerbatimText((String)value);
      break;
    case ROW_NATUREOFID:
      ((Determination)determinations.toArray()[rowIndex])
          .setNatureOfId((String)value);
      break;
    case ROW_DATEIDENTIFIED:
      ((Determination)determinations.toArray()[rowIndex])
