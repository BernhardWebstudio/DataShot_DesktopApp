...
public class DeterminationTableModel extends AbstractTableModel {
	...
	private static final Logger log = LoggerFactory.getLogger(DeterminationTableModel.class);
	...
	/**
	 * Constructor for cases where it is desirable to display the table with a cell
	 * editor (particularly an active button to pop up a details window or take
	 * another action on an ID)
	 *
	 * @param aDeterminationList
	 *            the lists of determinations to display in the table.
	 * @param enableIdEditor
	 *            true to include the determinationId to the table model in an
	 *            editable column.
	 */
	 ...
	 *
	 * @param aDetermination
	 *            the determination to add to the table model.
	 */
