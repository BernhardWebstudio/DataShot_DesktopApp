...
public class HigherGeographyComboBoxModel implements ComboBoxModel<MCZbaseGeogAuthRec> {
	...
	private static final Logger log = LoggerFactory.getLogger(HigherGeographyComboBoxModel.class);
	 ...
	 *
	 * @return a string representation of the higher geography from the currently
	 *         selected item, or null if there is no currently selected item.
	 */
