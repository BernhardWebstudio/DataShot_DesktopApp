...
public class NumberTableModel extends AbstractDeleteableTableModel {
	...
	private static final Logger log = LoggerFactory.getLogger(NumberTableModel.class);
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		if (rowIndex >= numbers.size()) {
			log.warn("Tried to get value in NumberTable at rowIndex higher than " + "row count; rowIndex: " + rowIndex
	...
	public void setValueAt(Object value, int rowIndex, int columnIndex) {
		if (rowIndex >= numbers.size()) {
			log.warn("Tried to set value in number table at rowIndex higher than " + "row count; rowIndex: " + rowIndex
