...
public class RunnableJobTableModel extends AbstractTableModel implements RunnerListener {
	...
	private static final Logger log = LoggerFactory.getLogger(RunnableJobTableModel.class);
	...
	/**
	 * Must be implemented for ButtonEditor to work. Needs to return Integer for row
	 * number column that is to contain button to work with ButtonEditor.
	 */
	 ...
	 *
	 * @param aJob
	 *            the RunnableJob to add to the table model.
	 */
