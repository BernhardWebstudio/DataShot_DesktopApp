...
public class SpecimenListTableModel extends AbstractTableModel {
	...
	/**
	 * Must be implemented for ButtonEditor to work. Needs to return Long for ID
	 * column that is to contain button to work with ButtonEditor.
	 */
	...
	public boolean isCellEditable(int rowIndex, int columnIndex) {
		boolean result = columnIndex == COL_ID
				|| (SpecimenDetailsViewPane.isCopyPasteActivated() && columnIndex == COL_COPY);
		return result;
	}
