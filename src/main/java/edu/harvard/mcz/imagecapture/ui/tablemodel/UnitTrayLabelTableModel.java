...
public class UnitTrayLabelTableModel extends AbstractTableModel {
	...
	/**
	 * When a new row is added the value of ordinal will be set to the value of the
	 * largest ordinal currently in the database plus 1.
	 */
	public static final int NEXT_ORDINAL_MAXPLUSONE = 1;
	private static final Logger log = LoggerFactory.getLogger(UnitTrayLabelTableModel.class);
	...
	public void setValueAt(Object value, int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
			...
			case 12 :
				...
				break;
			case COLUMN_TO_PRINT :
				labels.get(rowIndex).setNumberToPrint((Integer.parseInt(value.toString())));
				break;
			case COLUMN_PRINTED :
