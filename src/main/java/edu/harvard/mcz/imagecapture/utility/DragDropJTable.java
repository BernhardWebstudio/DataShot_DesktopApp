...
public class DragDropJTable extends JTable {
	...
	private static final Logger log = LoggerFactory.getLogger(DragDropJTable.class);
	...
	public DragDropJTable(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
		super(dm, cm, sm);
		setTransferHandler(new DdTransferHandler());
		setDragEnabled(true);
		thisTable = this;
	...
	/**
	 * Convert the selection to tab delimited cells and newline delimited rows.
	 *
	 * @return
	 */
