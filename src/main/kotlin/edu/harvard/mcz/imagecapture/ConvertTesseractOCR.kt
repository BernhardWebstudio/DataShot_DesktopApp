...
//String runCommand = "convert temptiff.jpg -depth 8 temptiff.tif";
                    val runCommand: String = (Singleton.Companion.getSingletonInstance().getProperties().getProperties().getProperty(ImageCaptureProperties.Companion.KEY_CONVERT_EXECUTABLE)
                            + " temptiff.jpg "
                            + Singleton.Companion.getSingletonInstance().getProperties().getProperties().getProperty(ImageCaptureProperties.Companion.KEY_CONVERT_PARAMETERS)
                            + " temptiff.tif")
