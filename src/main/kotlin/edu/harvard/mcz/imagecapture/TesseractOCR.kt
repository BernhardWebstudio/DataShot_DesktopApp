...
import edu.harvard.mcz.imagecapture.StreamReader
    ...
    val oCRText: String
        get() {
            ...
            try {
                ...
                // Run tesseract to OCR the target file.
                val runCommand: String = (Singleton.Companion.getSingletonInstance().getProperties().getProperties().getProperty(ImageCaptureProperties.Companion.KEY_TESSERACT_EXECUTABLE)
