 ...
 *
 */
package edu.harvard.mcz.imagecapture.dataimportimport
...
class BulkMedia {
    ...
    protected fun init() {
        ...
        fileBase = Singleton.Companion.getSingletonInstance()
                .getProperties()
                .getProperties()
                .getProperty(ImageCaptureProperties.Companion.KEY_IMAGEBASE)
        urlBase = Singleton.Companion.getSingletonInstance()
                .getProperties()
                .getProperties()
