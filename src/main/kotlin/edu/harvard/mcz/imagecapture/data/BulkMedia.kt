...
import javax.swing.JScrollBar edu.harvard.mcz.imagecapture.data.RunStatus
...
import boofcv.alg.fiducial.qrcode.QrCode georegression.struct.shapes.Polygon2D_F64
 ...
 */
class BulkMedia {
    private var media_uri: String? = null
    private var mime_type: String?
    private var media_type: String?
    private var media_relationships: String? = null
    private var media_labels: MutableList<String?>? = null
    private var preview_uri: String? = null
    private var urlBase: String? = "http://mczbase.mcz.harvard.edu/specimen_images/"
    private var fileBase: String? = "images"
    ...
    constructor(media_type: String?, mime_type: String?) {
    ...
    fun setCatalogNumber(guid: String?) {
        media_relationships = "shows cataloged_item=$guid"
    }

    fun setOriginalFilename(filename: String?) {
        media_labels!!.add("original filename=$filename")
    }

    fun setMadeDate(madeDate: String?) {
...
// separators
    ...
    companion object {
        private val log: Log = LogFactory.getLog(BulkMedia::class.java)
