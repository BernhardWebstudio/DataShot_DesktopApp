 ...
 */
interface PositionTemplateDetector {
    /**
    ...
    fun detectTemplateForImage(anImageFile: File?): String?

    @Throws(UnreadableFileException::class)
    fun detectTemplateForImage(scannableFile: CandidateImageFile?): String?
}
