        ...
        if (containedFiles != null) {
            for (i in containedFiles.indices) {
                if (status != RunStatus.STATUS_TERMINATED) {
                    ...
                    Singleton.Companion.getSingletonInstance().getMainFrame().setStatusMessage("Reconciling: " + fileToCheck!!.name)
...
// does file to check match pattern of an image file.
                        if (fileToCheck.name.matches(Singleton.Companion.getSingletonInstance().getProperties().getProperties().getProperty(ImageCaptureProperties.Companion.KEY_IMAGEREGEX))) { // it is an image file.
    ...
    private fun report(counter: Counter) {
        ...
        Singleton.Companion.getSingletonInstance().getMainFrame().setStatusMessage("File Reconciliation check complete")
        val errorReportDialog = RunnableJobReportDialog(Singleton.Companion.getSingletonInstance().getMainFrame(),
                report,
                counter.errors,
