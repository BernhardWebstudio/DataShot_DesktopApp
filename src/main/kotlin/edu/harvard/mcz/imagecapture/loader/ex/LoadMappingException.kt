 ...
 *
 */
class LoadMappingException : LoadException {
    /**
     * Default Constructor
     */
    constructor() : super("Error in mapping loaded data onto database schema.") {}
    ...
    companion object {
        private const val serialVersionUID = 8237869283328772180L
    }
}
