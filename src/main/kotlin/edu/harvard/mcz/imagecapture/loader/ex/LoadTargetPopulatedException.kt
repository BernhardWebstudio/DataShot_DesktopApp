 ...
 *
 */
class LoadTargetPopulatedException : LoadException {
    /**
     * Default Constructor
     */
    constructor() : super("Unable to update, would overwrite existing data in target record.") {}
    ...
    companion object {
        private const val serialVersionUID = -8299645420265628103L
    }
}
