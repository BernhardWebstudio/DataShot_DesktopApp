 ...
 *
 */
class LoadTargetSaveException : LoadException {
    /**
     * Default Constructor.
     */
    constructor() : super("Error saving updated target record.") {}
    ...
    companion object {
        private const val serialVersionUID = 8502180238419462095L
    }
}
