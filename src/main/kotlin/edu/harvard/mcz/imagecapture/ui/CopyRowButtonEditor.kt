...
class CopyRowButtonEditor : DefaultCellEditor {
    protected var button: JButton? = null
    private var label: String? = null
    private var isPushed = false
    private var target: Specimen? = null

    constructor(checkBox: JCheckBox) : super(checkBox) {
        button = JButton()
    ...
    constructor(textField: JTextField) : super(textField) {}
    ...
    override fun getTableCellEditorComponent(table: JTable, value: Any?,
        ...
        isPushed = true
        try {
            target = value as Specimen?
        } catch (e: Exception) { // TODO: handle?
        }
        return button
    }
