 ...
 *
 */
class ProgressBarRenderer : TableCellRenderer {
    ...
    override fun getTableCellRendererComponent(table: JTable?, value: Any?,
        ...
        if (value != null) {
            try {
                progressBar.setValue(value as Int)
    ...
    companion object {
        private val log: Log = LogFactory.getLog(ProgressBarRenderer::class.java)
        private const val serialVersionUID = 2860749265938403343L
    }
