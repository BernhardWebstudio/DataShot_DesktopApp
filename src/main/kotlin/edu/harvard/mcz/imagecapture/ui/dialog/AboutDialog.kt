...
java.awt.Toolkitimport java.awt.event.ActionEventimport java.awt.event.KeyEvent
...
class AboutDialog : JDialog() {
    ...
    private var thisDialog: AboutDialog? = null
    private var jPanel: JPanel? = null
    private var jTextFieldApp: JTextField? = null
    private var jTextFieldVersion: JTextField? = null
    private var jTextField: JTextField? = null
    private var jTextArea: JTextArea? = null
    private var jTextFieldCopyright: JTextField? = null
    private var jTextField1: JTextField? = null
    private var jTextField2: JTextField? = null
    private var textArea: JTextArea? = null
    private val lblLicence: JLabel? = null
    /**
    ...
    private fun getJPanel(): JPanel? {
        if (jContentPane == null) {
            ...
            jContentPane.add(jPanelWrapper, BorderLayout.SOUTH)
            jContentPane.add(jPanelContent, BorderLayout.CENTER)
        }
        return jContentPane
    }
     ...
     * @return javax.swing.JPanel
     */
    private val jPanelWrapper: JPanel?
        private get() {
            if (jPanel1 == null) {
                jPanel1 = JPanel()
     ...
     */
    private val jButtonClose: JButton?
        private get() {
            if (jButton == null) {
                jButton = JButton()
     ...
     * @return javax.swing.JPanel
     */
    private val jPanelContent: JPanel?
        private get() {
            if (jPanel == null) {
                jPanel = JPanel(MigLayout("wrap 2"))
                // set fields
     ...
     */
    private fun getJTextFieldApp(): JTextField? {
        if (jTextFieldApp == null) {
            jTextFieldApp = JTextField(ImageCaptureApp.APP_NAME)
    ...
    private fun getJTextField(): JTextField? {
        if (jTextField == null) {
            jTextField = JTextField(ImageCaptureApp.APP_REV)
     ...
     */
    private val jTextAreaDescription: JTextArea?
        private get() {
            if (jTextArea == null) {
                jTextArea = JTextArea(3, 50)
     ...
     * @return javax.swing.JTextField
     */
    private fun getJTextFieldCopyright(): JTextField? {
        if (jTextFieldCopyright == null) {
            jTextFieldCopyright = JTextField(ImageCaptureApp.APP_COPYRIGHT)
     ...
     * @return javax.swing.JTextField
     */
    private val jTextFieldContributors: JTextField?
        private get() {
            if (jTextField1 == null) {
                jTextField1 = JTextField(ImageCaptureApp.APP_CONTRIBUTORS)
     ...
     * @return javax.swing.JTextField
     */
    private val jTextFieldLibraries: JTextField?
        private get() {
            if (jTextField2 == null) {
                jTextField2 = JTextField(ImageCaptureApp.APP_LIBRARIES)
     ...
     * @return JTextArea
     */
    private val textAreaLicense: JTextArea?
        private get() {
            if (textArea == null) {
                textArea = JTextArea()
    ...
    companion object {
        private const val serialVersionUID = 5585851631769499899L
    }
