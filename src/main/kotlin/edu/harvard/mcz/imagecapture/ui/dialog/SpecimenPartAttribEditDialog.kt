 ...
 *
 */
class SpecimenPartAttribEditDialog : JDialog {
    private var thisDialog: SpecimenPartAttribEditDialog?
    private var targetAttribute: SpecimenPartAttribute?
    private val contentPanel: JPanel = JPanel()
    private var okButton: JButton? = null
    private var comboBoxType: JComboBox<String?>? = null
    private var comboBoxValue: JComboBox<String?>? = null
    ...
    constructor() {
        thisDialog = this
        targetAttribute = SpecimenPartAttribute()
        init()
    }

    constructor(attribute: SpecimenPartAttribute?) {
        thisDialog = this
    ...
    private fun configureComboBoxValue(item: String) {
    ...
    companion object {
        private const val serialVersionUID = -549010965241755136L
        private val log: Log = LogFactory.getLog(SpecimenPartAttribEditDialog::class.java)
    }
}
