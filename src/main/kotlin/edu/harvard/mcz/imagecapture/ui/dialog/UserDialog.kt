...
java.awt.Insetsimport java.awt.Toolkitimport java.awt.event.ActionEvent
...
class UserDialog : JDialog {
    private var thisDialog: UserDialog? = null // allow reference to this in button event methods
    ...
    private var jLabelMessage: JLabel? = null
    private var userToEdit: Users? = null
    /**
     ...
     */
    constructor() : super(Singleton.Companion.getSingletonInstance().getMainFrame(), true) // construct as modal dialog
    {
        thisDialog = this
        userToEdit = Users()
     ...
     */
    constructor(aUser: Users?) : super(Singleton.Companion.getSingletonInstance().getMainFrame(), true) // construct as modal dialog
    {
        thisDialog = this
        userToEdit = aUser
        initialize()
    ...
    private fun initialize() {
        this.setSize(Dimension(504, 188))
        ...
        if (jButtonSave == null) {
            ...
            jButtonSave.addActionListener(object : ActionListener {
                override fun actionPerformed(e: ActionEvent?) {
                    ...
                    try {
                        val usersToCheck: MutableList<Users?> = u.findByNames(check.getUsername(), check.getFullname())
                        ...
                        setMessage("Unable to save this record. Name or About may be too long; " + ex.message)
                    }
                }
            })
        }
    ...
    private fun getJPanel2(): JPanel? {
        if (jPanel2 == null) {
            ...
            gridBagConstraints8.insets = Insets(0, 0, 20, 0)
            ...
            gridBagConstraints2.insets = Insets(0, 6, 0, 0)
    ...
    companion object {
        private const val serialVersionUID = -8881672324009775369L
    }
