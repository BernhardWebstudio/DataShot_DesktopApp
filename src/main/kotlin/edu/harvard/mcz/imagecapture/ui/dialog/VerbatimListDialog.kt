 ...
 *
 */
class VerbatimListDialog : JDialog(), DataChangeListener {
    ...
    protected fun init() {
        ...
        table = JTable(VerbatimCountTableModel(sls.countDistinctVerbatimValues()))
        table.setDefaultRenderer(VerbatimCount::class.java, ButtonRenderer("Edit"))
        table.setDefaultEditor(VerbatimCount::class.java, ButtonEditor(ButtonEditor.Companion.OPEN_VERBATIM_CLASSIFY, this))
    ...
    companion object {
        private const val serialVersionUID = 6589370164897719328L
        private val log: Log = LogFactory.getLog(VerbatimListDialog::class.java)
    }
