 ...
 *
 */
class VerbatimToTranscribeDialog : JDialog() {
    private val contentPanel: JPanel? = JPanel()
    private var table: JTable? = null

    companion object {
        private const val serialVersionUID = 1871411835203004797L
        private val log: Log = LogFactory.getLog(VerbatimToTranscribeDialog::class.java)
    }
    ...
    init {
        ...
        contentPanel.setLayout(BorderLayout(0, 0))
        {
            ...
            val model = GenusSpeciesCountTableModel(sls.countSpecimensForVerbatim())
            table.setModel(model)
            table.setDefaultRenderer(GenusSpeciesCount::class.java, ButtonRenderer("Transcribe"))
            table.setDefaultEditor(GenusSpeciesCount::class.java, ButtonEditor(ButtonEditor.Companion.OPEN_SPECIMEN_VERBATIM, this))
