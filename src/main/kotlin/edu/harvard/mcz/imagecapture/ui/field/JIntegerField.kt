package edu.harvard.mcz.imagecapture.ui.fieldimport
 ...
 */
class JIntegerField : JTextField, ActionListener {
    var value: Number? = 0
    var admissibleValues: IntArray? = null
    ...
    constructor(value: Int, format: String?, actionListener: ActionListener?) : super() {
        this.addActionListener(actionListener)
        this.addActionListener(this)
        setValue(value)
    }

    constructor(value: Int, actionListener: ActionListener?) : super() {
        this.addActionListener(actionListener)
        this.addActionListener(this)
        setValue(value)
    }
    ...
    fun setRange(lowerBound: Int, upperBound: Int) {
    ...
    fun setAdmissibleValues(admissibleValues: IntArray?) {
        this.admissibleValues = admissibleValues
    }

    fun add(increment: Int) {
    ...
    private fun updateData() {
        ...
        // Apply bounds
        value = Math.min(Math.max(lowerBound, value.intValue()), upperBound)
    ...
    private val admissibleValueIndex: Int
        private get() =// Constrain to admissibleValues
            if (admissibleValues != null && admissibleValues!!.size > 0) {
                var index: Int = Arrays.binarySearch(admissibleValues, value.intValue())
