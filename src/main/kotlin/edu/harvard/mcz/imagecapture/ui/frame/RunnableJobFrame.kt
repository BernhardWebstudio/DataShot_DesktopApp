...
class RunnableJobFrame : JFrame() {
    ...
    private fun initialize() {
        ...
        this.setPreferredSize(Dimension(600, 300))
    ...
    private fun getJTable(): JTable? {
        if (jTable == null) {
            jTable = JTable(Singleton.Companion.getSingletonInstance().getJobList())
...
// jTable.setDefaultRenderer(int.class, new ProgressBarRenderer());
    ...
    companion object {
        private const val serialVersionUID = -8754185517572012300L
    }
