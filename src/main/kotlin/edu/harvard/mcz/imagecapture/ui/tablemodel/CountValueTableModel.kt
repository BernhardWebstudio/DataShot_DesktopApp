 ...
 *
 */
class CountValueTableModel : AbstractTableModel {
    private var items: MutableList<CountValue?>? = null
    private var itemType: String? = null

    constructor() {
        items = ArrayList<CountValue?>()
        itemType = "Value"
    }

    constructor(countValueItemList: MutableList<CountValue?>?) {
        items = countValueItemList
        itemType = "Value"
    }

    constructor(countValueItemList: MutableList<CountValue?>?, valueColumnHeader: String?) {
        items = countValueItemList
    ...
    companion object {
        private val log: Log = LogFactory.getLog(CountValueTableModel::class.java)
        private const val serialVersionUID = -1744182887180402474L
    }
}
