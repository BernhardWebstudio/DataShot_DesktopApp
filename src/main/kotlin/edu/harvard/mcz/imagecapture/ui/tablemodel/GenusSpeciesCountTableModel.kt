 ...
 *
 */
class GenusSpeciesCountTableModel : AbstractTableModel {
    private var genusSpeciesCounts: MutableList<GenusSpeciesCount?>? = null

    constructor() {
        genusSpeciesCounts = ArrayList<GenusSpeciesCount?>()
    }

    constructor(genusSpeciesCounts: MutableList<GenusSpeciesCount?>?) {
    ...
    companion object {
        private const val serialVersionUID = 1907248383164693796L
        private val log: Log = LogFactory.getLog(GenusSpeciesCountTableModel::class.java)
    }
}
