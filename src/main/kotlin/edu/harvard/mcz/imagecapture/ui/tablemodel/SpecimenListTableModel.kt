 ...
 */
class SpecimenListTableModel(specimenList: MutableList<Specimen?>?) : AbstractTableModel() {
    private var specimens: MutableList<Specimen?>? = null
    private val copyBtn: JButton? = null
...
// and ** Must Not ** return Long for any other column).
    ...
    override fun getColumnName(columnIndex: Int): String? {
        ...
        when (columnIndex) {
            COL_ID -> result = "Edit"
            COL_COPY -> result = "Copy"
            COL_BARCODE -> result = "Barcode"
            COL_WORKFLOW -> result = "Workflow"
            COL_FAMILY -> result = "Family"
            COL_SUBFAMILY -> result = "Subfamily"
            COL_TRIBE -> result = "Tribe"
            COL_GENUS -> result = "Genus"
            COL_SPECIFIC -> result = "Species"
            COL_SUBSPECIFIC -> result = "Subspecies"
            COL_VERBLOCALITY -> result = "Verbatim Locality"
            COL_COUNTRY -> result = "Country"
            COL_DIVISION -> result = "State/Province"
        }
        return result
    }
...
// renderer that can hear mouse clicks.
    ...
    companion object {
        const val COL_ID = 0
        const val COL_COPY = 1
        const val COL_BARCODE = 2
        const val COL_WORKFLOW = 3
        const val COL_FAMILY = 4
        const val COL_SUBFAMILY = 5
        const val COL_TRIBE = 6
        const val COL_GENUS = 7
        const val COL_SPECIFIC = 8
        const val COL_SUBSPECIFIC = 9
        const val COL_COUNTRY = 10
        const val COL_DIVISION = 11
        const val COL_VERBLOCALITY = 12
        /* (non-Javadoc)
     * @see javax.swing.table.TableModel#getColumnCount()
     */
        const val columnCount = 13
        private val log: Log? = LogFactory.getLog(SpecimenListTableModel::class.java)
        private const val serialVersionUID = -8394267503927374758L
    }
