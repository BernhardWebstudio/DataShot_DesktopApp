...
org.apache.commons.logging.LogFactoryimport java.util.ArrayList
 ...
 *
 */
class VerbatimCountTableModel : AbstractTableModel {
    private var verbatimCounts: MutableList<VerbatimCount?>?

    constructor() {
        verbatimCounts = ArrayList<VerbatimCount?>()
    }

    constructor(verbatimCounts: MutableList<VerbatimCount?>?) {
        this.verbatimCounts = verbatimCounts
    }

    fun fireDataHasChanged() {
    ...
    override fun getColumnName(column: Int): String? {
        var result: String = super.getColumnName(column)
        when (column) {
            0 -> result = " "
            1 -> result = "Count"
            2 -> result = "Verb. Locality"
            3 -> result = "Verb. Date"
            4 -> result = "Verb. Collector"
            5 -> result = "Verb. Collection"
            6 -> result = "Verb. Numbers"
            7 -> result = "Other Text"
        }
        return result
    }
    ...
    companion object {
        private const val serialVersionUID = 834148063219117706L
        private val log: Log? = LogFactory.getLog(VerbatimCountTableModel::class.java)
    }
}