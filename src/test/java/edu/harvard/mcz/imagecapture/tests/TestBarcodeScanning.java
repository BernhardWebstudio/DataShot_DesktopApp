...
public class TestBarcodeScanning extends TestCase {
	...
	/**
	 * Test method for
	 * {@link edu.harvard.mcz.imagecapture.CandidateImageFile#getBarcodeText()}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link edu.harvard.mcz.imagecapture.CandidateImageFile#getBarcodeStatus()}.
	 */
	@Test
	...
	public void testreadBarcodeFromLocation() {
		...
		assertEquals("MCZ-ENT00634766",
				candidateImageFile.readBarcodeFromLocation(image, left, top, width, height, false));
