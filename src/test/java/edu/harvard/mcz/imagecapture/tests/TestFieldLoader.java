...
public class TestFieldLoader {
	private static final Logger log = LoggerFactory.getLogger(TestFieldLoader.class);
	...
	// edu.harvard.mcz.imagecapture.loader.FieldLoader#load(java.lang.String,
	...
	// }
	// try {
	// f.load("MCZ-ENT00525604", "Africa", "1820", "Should update
	// first time"); } catch (LoadTargetRecordNotFoundException ex) {
	// // expected exception
	// } catch (LoadException e) {
	// log.error(e.getMessage(),e);
	// fail(e.getMessage());
	...
	// /**
	// * Test method for {@link
	// edu.harvard.mcz.imagecapture.loader.FieldLoader#loadFromMap(java.lang.String,
	// java.util.Map)}.
	// */
	// @Test
