...
/**
 * TestOfPositionTemplate tests the construction of PositionTemplate and the
 * internal consistency of the list of templates provided by PositionTemplate
 * and the default template known to the Singleton.
 */
...
public class TestOfPositionTemplate extends TestCase {
	...
	/**
	 * Test method for
	 * {@link edu.harvard.mcz.imagecapture.PositionTemplate#PositionTemplate()}.
	 */
	...
	/**
	 * Test method for
	 * {@link edu.harvard.mcz.imagecapture.PositionTemplate#PositionTemplate(java.lang.String)}.
	 */
	...
	public void testDefaultPositionTemplateInSingleton() {
		try {
			PositionTemplate defaultTemplate = new PositionTemplate(Singleton.getSingletonInstance().getProperties()
					.getProperties().getProperty(ImageCaptureProperties.KEY_DEFAULT_TEMPLATES));
	...
	protected void tearDown() throws Exception {
		super.tearDown();
		// reference the MainFrame again so it won't be disposed of until these tests
		// are done.
		Singleton.getSingletonInstance().getMainFrame().setVisible(false);
	}
