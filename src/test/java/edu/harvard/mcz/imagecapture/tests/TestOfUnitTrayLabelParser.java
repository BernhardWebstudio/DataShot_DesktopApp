...
public class TestOfUnitTrayLabelParser extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		originalRegexDrawerNumber = Singleton.getSingletonInstance().getProperties().getProperties()
				.getProperty(ImageCaptureProperties.KEY_REGEX_DRAWERNUMBER);
		// then set to the default value (which the tests expect) while running the
		// tests.
		Singleton.getSingletonInstance().getProperties().getProperties()
				.setProperty(ImageCaptureProperties.KEY_REGEX_DRAWERNUMBER, ImageCaptureApp.REGEX_DRAWERNUMBER);
	}
	...
	protected void tearDown() throws Exception {
		super.tearDown();
		// Reset the regex for the drawer number to not lose local properties settings
		// from testing.
		Singleton.getSingletonInstance().getProperties().getProperties()
				.setProperty(ImageCaptureProperties.KEY_REGEX_DRAWERNUMBER, originalRegexDrawerNumber);
	}

	/**
	 * Test method for
	 * {@link edu.harvard.mcz.imagecapture.UnitTrayLabelParser#UnitTrayLabelParser(java.lang.String)}.
	 */
