...
/**
 * Tests for Specimen persistence, cascading, and GenericLifeCycle findByExample.
 */
public class TestSpecimenPersistence extends TestCase {
    ...
    public void testSpecimenCRUDAndFindByExample() throws SaveFailedException {
        ...
        // 3. Find by example using GenericLifeCycle (tests string comparison and filtering)
